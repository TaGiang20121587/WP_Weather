...
namespace AppWeather
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            this.txtCountry.ItemsSource = Country.LoadData();
            this.txtCountry.ItemFilter = SearchPhones;
        }
        bool SearchPhones(string search, object value)
        {
            if (value != null)
            {
                ...
                String key = c.Name;
                if (key.ToLower().StartsWith(search.ToLower()))
                    return true;
            }
            return false;
        }
        ...
        {
            Country country = txtCountry.SelectedItem as Country;
            if (country == null)
            {
